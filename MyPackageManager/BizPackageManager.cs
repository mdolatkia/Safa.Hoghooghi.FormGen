...
namespace MyPackageManager
{
    public class BizPackageManager
    {
        ...
        //public DP_EntityCommandsResult GetEntityCommands(DP_EntityCommandsRequest request)
        //{
           
        //}
    
        public DP_EntityStatesResult GetEntityStates(DP_EntityStatesRequest request)
        {
            BizEntityState bizEntityState = new BizEntityState();
            DP_EntityStatesResult result = new DP_EntityStatesResult();
            result.States = bizEntityState.GetEntityStates(request.EntityID, true);
            return result;
        }
