...
namespace MyUIGenerator
{
    ...
    public class UIManager : IAgentUIManager
    {
        ...
        public void ActivatePane(string v)
        {
            throw new NotImplementedException();
        }
        ...
        public void AddMenuSeprator(object contextMenu)
        {
            throw new NotImplementedException();
        }
        ...
        public List<MyMenuItem> GetCurrentMenuItems(object contextMenu)
        {
            throw new NotImplementedException();
        }
        ...
        public MyMenuItem GetMenuItem(object parentMenu, string header, string name, string tooltip = null)
        {
            throw new NotImplementedException();
        }
        ...
        public bool PaneIsOpen(string v)
        {
            throw new NotImplementedException();
        }
        ...
        public void RemoveMenuItem(object contextMenu, object menuItem)
        {
            throw new NotImplementedException();
        }
        ...
        public ConfirmResul ShowConfirm(string title, string message, UserPromptMode dialogMode)
        {
            throw new NotImplementedException();
        }
        ...
        public void ShowInfo(string title, string detail = "", InfoColor infoColor = InfoColor.Black)
        {
            throw new NotImplementedException();
        }
