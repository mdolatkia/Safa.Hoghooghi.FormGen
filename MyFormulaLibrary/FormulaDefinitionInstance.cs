...
namespace MyFormulaFunctionStateFunctionLibrary
{
    public class FormulaDefinitionInstance
    {
        ...
        public FormulaDefinitionInstance(DR_Requester requester, DP_DataRepository mainObject)
        {
            Requester = requester;
        ...
        private void BindableTypeDescriptor_PropertyGetCalled(object sender, PropertyGetArg e)
        {
            ...
            if (e.PropertyInfo.ValueSearched == false)
            {
                if (e.PropertyInfo.PropertyType == PropertyType.Relationship)
                {
                    ...
                    newObject.DataItem = new DP_DataRepository(e.PropertyInfo.RelationshipPropertyInfo.Relationship.EntityID2, e.PropertyInfo.RelationshipPropertyInfo.Relationship.Entity2);
        ...
        public EntityAndProperties GetEntityAndProperties(string entityName)
        {
            ...
            else
            {
                ...
                if (entityID != 0)
                {
                    ...
                    return AllRegisterdProperties.FirstOrDefault(x => x.Entity.ID == entityID);
                }
            }
            return null;
        }
